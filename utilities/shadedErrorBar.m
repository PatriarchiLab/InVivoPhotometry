...
patchSaturation=0.3; %How de-saturated or transparent to make patch %used to be 0.15
if transparent
    faceAlpha=patchSaturation;
    patchColor=col;
%     set(gcf,'renderer','openGL')
    set(gcf,'renderer','painters') %this is for vector graphics, so better for Figures
else
    faceAlpha=1;
